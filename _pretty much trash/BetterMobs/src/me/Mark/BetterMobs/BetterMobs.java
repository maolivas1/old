...
public class BetterMobs implements Listener {
	...
	static boolean dropHead;
	static boolean zombieWear;
	static boolean pigZombieWear;
	static boolean skeletonWear;
	static boolean onlyOnline;
	static boolean colorSheep;
	static double pigSaddle;
	static double horseTamed;
	static double horseSaddle;
	static double horseChest;
	...
	public void spawn(EntitySpawnEvent event) {
		...
		/*	
			//TODO Fix this it dosnt work right :P
