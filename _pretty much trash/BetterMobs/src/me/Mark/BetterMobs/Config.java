...
public class Config {
	...
	public static void set(String thing, String value) {
		 try {
			 File file = new File(System.getProperty("user.dir") + "/plugins/BetterMobs/");
	...
	public static String get(String thing) {
		try {
	        YamlConfiguration c = YamlConfiguration.loadConfiguration(new File(System.getProperty("user.dir") + "/plugins/BetterMobs/", "config.yml"));
	        if (c.contains(thing))
